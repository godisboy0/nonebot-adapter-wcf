...
"""
照抄 https://github.com/JustUndertaker/adapter-ntchats
我觉得Event定义很全面，应该没啥大的问题。
这里有很多是强平台相关的，可用于一些微信专用插件。
"""
...
class TextMessageEvent(MessageEvent):
    ...
    wx_raw_type: int = WxType.WX_MSG_TEXT
...
class PictureMessageEvent(MessageEvent):
    ...
    wx_raw_type: int = WxType.WX_MSG_PICTURE
    raw_msg: str
    """微信中的原始消息,xml格式"""
    image_thumb: str
    """图片缩略图路径"""
...
class VoiceMessageEvent(MessageEvent):
    ...
    wx_raw_type: int = WxType.WX_MSG_VOICE
    mp3_file: str
    """语音消息文件"""
    raw_msg: str
    """微信中的原始消息,xml格式"""
...
class CardMessageEvent(MessageEvent):
    ...
    wx_raw_type: int = WxType.WX_MSG_CARD
    headimg_url: str
    """头像url"""
    nickname: str
    """名片用户昵称"""
...
class VideoMessageEvent(MessageEvent):
    ...
    wx_raw_type: int = WxType.WX_MSG_VIDEO
    video: str
    "接收视频路径"
    video_thumb: str
    "视频缩略图路径"
...
class EmojiMessageEvent(MessageEvent):
    ...
    wx_raw_type: int = WxType.WX_MSG_EMOJI
    emoji_url: str
    """表情url地址"""
    raw_msg: str
    """微信中的原始消息,xml格式"""
...
class LocationMessageEvent(MessageEvent):
    ...
    wx_raw_type: int = WxType.WX_MSG_LOCATION
    location_x: str
    """位置x坐标"""
    location_y: str
    """位置y坐标"""
...
class FileMessageEvent(MessageEvent):
    ...
    wx_raw_type: int = WxType.WX_MSG_FILE
    file: str
    """接收文件路径"""
    file_name: str
    """接收文件名称"""
...
class SystemMessageEvent(Event):
    ...
    wx_raw_type: int = WxType.WX_MSG_SYSTEM
    timestamp: int
    """时间戳"""
    wx_type: int
    """消息原始类型"""
...
class FriendAddRequestEvent(RequestEvent):
    ...
    wx_raw_type: int = WxType.WX_MSG_FRIEND
    raw_msg: str
    """微信中的原始消息,xml格式"""
...
class RevokeNoticeEvent(NoticeEvent):
    ...
    # wx_raw_type: int = WxType.WX_MSG_REVOKE
    wx_type: int
    """消息原始类型"""
    from_wxid: str
    """发送者的wxid"""
...
class LinkMessageEvent(AppEvent):
    ...
    # wx_raw_type: int = WxType.WX_MSG_LINK
